...
def parse_driver_info(node):
    ...
    validator = validators.Validator().require_presence_of('scheme', 'host')
    try:
...
def handle_ibmc_exception(action):
    ...
    def decorator(f):
        ...
        @retrying.retry(
            retry_on_exception=(
                lambda e: isinstance(e, exception.IBMCConnectionError)),
        ...
        def wrapper(*args, **kwargs):
            ...
            # validate task node driver info
            # parse_driver_info(task.node)
